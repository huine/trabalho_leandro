...
class Eventos(SimpleItem):
    ...
    def add_evento(self, id_usuario, id_lista, data_inicio, data_fim,
                   hora_inicio, hora_fim, descricao, local, titulo,
                   prioridade):

        self._zsql_insere_evento(
            id_lista=id_lista, titulo_evento=titulo, data_inicio=data_inicio,
            data_fim=data_fim, hora_inicio=hora_inicio, hora_fim=hora_fim,
